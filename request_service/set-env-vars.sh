...
export MYSQL_CONTAINER_NAME=assignment_mysql_request_service
export MYSQL_DBNAME=assignment_mysql_request_service
export MYSQL_URL="jdbc:mysql://$HOST_IP:6607/$MYSQL_DBNAME?useSSL=false"
