...
export MYSQL_CONTAINER_NAME=assignment_mysql_offer_service
export MYSQL_DBNAME=assignment_mysql_offer_service
export MYSQL_URL="jdbc:mysql://$HOST_IP:6608/$MYSQL_DBNAME?useSSL=false"
